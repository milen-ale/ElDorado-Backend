  ...
  path '/api/v1/users/{user_id}/reservations' do
    get 'Get user car reservations' do
      ...
      response '200', 'User Car reservation found' do
        before do
         @user = User.create(name: 'Abel G', email: 'abelg@jedi.com', password: 'password', password_confirmation: 'password')
         @car = Car.create(name: 'Toyota', image: 'https://www.toyota.com/imgix/responsive/images/mlp/colorizer/2020/camry/01.png?auto=format%2Ccompress&fit=crop&h=400&w=800', model: 'Camry', daily_price: 100, description: 'A nice car')
        ...
        schema type: :array,
          ...
          type: :object,
            ...
            required: ['id', 'pickup_date', 'return_date', 'car']
          }
        run_test!
      end
  ...
  path '/api/v1/users/{user_id}/reservations' do
    post 'Reserve A Car' do
      ...
      parameter name: :booking, in: :body, schema: {
        ...
        required: ['pickup_date', 'return_date', 'car_id']
      }
